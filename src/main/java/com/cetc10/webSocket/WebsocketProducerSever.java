...
@Component
@ServerEndpoint("/webSocketProducer/{wid}")
public class WebsocketProducerSever {
    ...
    private static ConcurrentHashMap<String, WebsocketProducerSever> websocketMap = new ConcurrentHashMap<>();
...
//              session.getBasicRemote().sendText(message);
    ...
    public static synchronized void addOnlineCount() {
        WebsocketProducerSever.onlineCount++;
    }
    ...
    public static ConcurrentHashMap<String, WebsocketProducerSever> getWebsocketMap() {
        return websocketMap;
    }
}
